...
osThreadId controlTskHandle;
uint32_t controlTskBuffer[ 128 ];
osStaticThreadDef_t controlTskControlBlock;
...
/* USER CODE BEGIN Header_StartControlTsk */
/**
  * @brief  Function implementing the controlTsk thread.
  * @param  argument: Not used 
  * @retval None
  */
/* USER CODE END Header_StartControlTsk */
__weak void StartControlTsk(void const * argument)
{
